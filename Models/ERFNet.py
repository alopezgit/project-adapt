...
class DownsamplerBlock (nn.Module):
    def __init__(self, ninput, noutput):
        ...
        self.bn_s = self.bn
        self.bn_t = nn.BatchNorm2d(noutput, eps=1e-3)
...
class non_bottleneck_1d (nn.Module):
    def __init__(self, chann, dropprob, dilated):
        ...
        self.bn1_s = self.bn1 
        self.bn1_t = nn.BatchNorm2d(chann, eps=1e-03)

        self.bn2_s = self.bn2
        self.bn2_t = nn.BatchNorm2d(chann, eps=1e-03)
...
class Net(nn.Module):
    ...
    def forward(self, input, only_encode=False):
        if only_encode:
            ...
            return self.decoder.forward(output), output
